...
public class DatabaseManager {
	...
	public String[] appNames() {
		...
		try {
			Cursor cursor = db.query(TABLE_NAME, new String[] { "appName" },
					null, null, null, null, "appID");
			cursor.moveToFirst();
	...
	public int select(String appName, String column) {
		...
		try {
			Cursor cursor = db.query(TABLE_NAME, cols, whereClause, whereArgs,
					null, null, null, null);
			// Cursor cursor = db.query(TABLE_NAME, cols, null, null, null,
			// null, null, null);
